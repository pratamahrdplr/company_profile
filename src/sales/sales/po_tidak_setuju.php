    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <form class="form" action="?page=po_tidak_setuju" enctype="multipart/form-data" method="post">
          ...
          <table id="datatable-responsive" class="table table-striped jambo_table bulk_action" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              if (($tanggal_input_awal == '') and ($tanggal_input_sampai == '')) {
                ...
                $penawaran_query = mysql_query("select * from tb_po  where id_user = '$session_user' AND status_po='tolak' ") or die(mysql_error());
              } else {
                $penawaran_query = mysql_query("select * from tb_po where id_user = '$session_user'  AND status_po='tolak' AND DATE_FORMAT(tanggal_po,'%m/%d/%Y')  BETWEEN '$tanggal_input_awal' AND '$tanggal_input_sampai'") or die(mysql_error());
              }
