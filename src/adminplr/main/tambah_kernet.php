<div class="row">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Tambah Kernet</div>
                      		  			</div>
...
<div class="content-box-large">
                  <br />
                  <form class="form-horizontal input_mask" action="insert_kernet.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="hp" id="5" placeholder="Phone" >
                </div>
                </div>
                 <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text"  required="required" class="form-control col-md-7 col-xs-12" name="ktp" id="6" placeholder="No KTP" >
                </div>
                </div>
