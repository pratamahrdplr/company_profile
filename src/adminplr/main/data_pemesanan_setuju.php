...
<a href="?page=data_pemesanan_setuju" class="btn btn-warning">Order di Setujui </a>
...
$tanggal_input_sampai = $_POST["tanggal_input_sampai"];
    ?>
<form class="form" action="?page=data_pemesanan_setuju" enctype="multipart/form-data" method="post">
...
<div class="content-box-large">
    ...
    <!-----------------------------------Content------------------------------------>
    <?php
	$po_query = mysql_query("select * from tb_po where id_user = '$mkrt' and status_po = 'setuju'")or die(mysql_error());
   ...
   <tr>
    ...
    <td>
<a href="print_po.php?id_po=<?php echo $rowp['id_po']; ?>" class="btn btn-success btn-xs" target="_blank">Print</a>
