<div class="row">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Purchase Order Perusahaan</div>
   ...
   <?php
	...
	$user_query = mysql_query("select * from tb_user where id_user = '$row_pel[id_user]; ?>'")or die(mysql_error());
		...
		?>
<a href="?page=po_km&id_kontak=<?php echo $row_pel['id_kontak'] ?>" class="btn btn-success">PO KM</a>
<form action="tambah_po.php" enctype="multipart/form-data" method="post">
...
<span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
 ...
 <td>Email Pelanggan</td>
   ...
   <tr>
    ...
    <td>NPWP : </td>
<td> <input type="text" name="npwp_po" id="npwp" class="form-control" value="" required /></td>
  </tr>
    <tr>
    <td>Pembayaran</td>
    <td colspan="2">   
