...
$query=mysql_query("update tb_po set nama_kontak_po = '$_POST[nama_kontak_po]' , npwp = '$_POST[npwp_po]' , penerima_barang = '$_POST[penerima_barang]' ,  no_telp_penerima = '$_POST[no_telp_penerima]' , penanggung_bayar = '$_POST[penanggung_bayar]' , no_penanggung_bayar = '$_POST[no_penanggung_bayar]' , harga_po = '$_POST[harga_po]' ,vol_po = '$_POST[vol_po]' ,fee_po = '$_POST[fee_po]' , id_oat = '$_POST[oat]' , tanggal_po = '$tanggal_po' , tanggal_kirim = '$tgl' , pukul_kirim = '$_POST[pukul_kirim]' ,  alamat_kirim = '$_POST[alamat_kirim]' , pembayaran_po = '$_POST[pembayaran_po]' , jatuh_tempo = '$tempo' , status_po ='setuju' , kelengkapan_po = '$_POST[kelengkapan_po]'  where id_po = '$_POST[id_po]'") or die (mysql_error());
