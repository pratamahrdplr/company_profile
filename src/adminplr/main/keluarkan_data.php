   <div class="row">
		  		<div class="col-md-12 panel-warning">
		  			<div class="content-box-header panel-heading">
	  					<div class="panel-title ">Keluarkan Data</div>
...
<input name="filter_tanggal" type="submit" value="Filter"  class="btn btn-success"/>
    ...
    <form class="form" method="post" action="del_data_user.php">
...
<input name="" type="submit" value="Keluarkan" class="btn btn-success" />
    </form>
    </div>
