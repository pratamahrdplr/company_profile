...
if ($jum < 1) {
    ...
    for ($x = 0; $x < $jum; $x++) {
        ...
        $query = mysql_query("update tb_kontak_all set id_user  = '$_POST[id_user]', status_kontak ='belum dihubungi', tanggal_bagi  = NOW() where id_kontak = '$pel' ") or die(mysql_error());
    }
    if ($query)
