...
?>
<form action="update_po.php" enctype="multipart/form-data" method="post">
...
<td ><input type="text" name="nama_kontak_po" class="form-control" value="<?php echo $row_pen['nama_kontak_po']; ?>" required /></td>
</tr>
...
<td>
    ...
    <div class="input-group date form_date1 col-md-10" data-date="" data-date-format="yyyy-mm-dd" data-link-field="tanggal_po" data-link-format="yyyy-mm-dd">
<input class="form-control" size="16" type="text" value="" name="tanggal_po" readonly>
...
<tr>
<td>NPWP : </td>
<td> <input type="text" name="npwp_po" id="npwp" class="form-control"  value="<?php echo $row_pen['npwp']; ?>" required /></td>

</tr>
<tr>
<td>Penanggung Jawab Pembayaran</td>
<td><input type="text" name="penanggung_bayar" class="form-control" value="<?php echo $row_pen['penanggung_bayar']; ?>"/></td>
</tr>

<tr>
<td>No. Telpon Penanggung Jawab Pembayaran </td>
<td><input type="text" name="no_penanggung_bayar" class="form-control" value="<?php echo $row_pen['no_penanggung_bayar']; ?>"/></td>
</tr>
<tr>
<td>Pembayaran</td>
<td colspan="3">   
