...
<a href="?page=data_pengiriman_sudah" class="btn btn-warning">Sudah Kirim</a>
...
if(($tanggal_input_awal=='') AND ($tanggal_input_sampai=='')){
                    ...
                    $penawaran_query = mysql_query("select * , DATE_FORMAT(tanggal_kirim,'%d-%m-%Y') as TANGGAL from tb_po where status_po ='setuju' and status_kirim ='sudah kirim'")or die(mysql_error());
}else{
