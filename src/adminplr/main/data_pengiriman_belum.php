...
<a href="?page=data_pengiriman_belum" class="btn btn-warning">Belum Kirim</a>
<a href="?page=data_pengiriman_sudah" class="btn btn-success">Sudah Kirim</a>
<a href="?page=data_pengiriman" class="btn btn-success">Data Pengiriman All</a>
...
if(($tanggal_input_awal=='') AND ($tanggal_input_sampai=='')){
                    ...
                    $penawaran_query = mysql_query("select * , DATE_FORMAT(tanggal_kirim,'%d-%m-%Y') as TANGGAL from tb_po where status_po ='setuju' and status_kirim ='belum kirim'")or die(mysql_error());
}else{
...
?>
<a href="sudah_kirim.php?id_kirim=<?php echo $row_pn['id_po']; ?>" class="btn btn-warning btn-sm"><i class="glyphicon glyphicon-arrow"></i>Sudah Kirim</a>

<?php
}
?>           
 
<a href="invoice.php?id_po=<?php echo $row_pn['id_po']; ?>" class="btn btn-success btn-sm" target="_blank" ><i class="glyphicon glyphicon-send"></i> Cetak Invoice</a>
