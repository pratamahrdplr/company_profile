			<div class="container">
			    <div class="row" style="padding-top:15px;">
			                        ...
			                        <div class="post-image">
			                            <div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
			                                <div>
			                                    ...
			                                    <?php if ($rows['gambar'] != '') {
                                                    echo "<div class='img-thumbnail' style='display:inherit;'><img  class='img-responsive' style='width:100%' src='" . base_url() . "asset/foto_statis/$rows[gambar]' alt='$rows[judul]' /></a></div>";
                                                } ?>
			        ...
			        <a href="https://api.whatsapp.com/send?phone=6285733988103&amp;text=Halo%20PTSBK,%20Saya%20mau%20order%20Solar%20Industri">
