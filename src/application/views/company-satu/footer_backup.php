 		...
 		<div class="col-md-9">
 			<div class="row">
 				...
 				<div class="col-md-3">
 					<h5>Tools</h5>
 					<ul class="list list-icons list-icons-sm">
 						<!-- <li><i class="fa fa-caret-right"></i> <a href="https://mail.pertamina.com/owa/">Webmail</a></li> -->
 		...
 		<div class="col-md-3">
 			...
 			<ul class="social-icons mt-xl">
 				...
 				<li style="box-shadow:none;">
 					<h5 style="font-size:16px;text-transform:none;">| @Pertamina</h5>
 				</li>
 			</ul>
 ...
 <div class="footer-copyright">
 	<div class="container">
 		<div class="row">
 			<div class="col-md-11">
 				<p>© Copyright PT Pertamina(Persero) 2018. All Rights Reserved.</p>
 			</div>
 		</div>
 	</div>
 </div>